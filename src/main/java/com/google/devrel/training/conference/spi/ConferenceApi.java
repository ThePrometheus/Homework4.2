...
import static com.google.devrel.training.conference.form.service.OfyService.ofy;
...
import com.google.devrel.training.conference.form.service.OfyService;
...
public class ConferenceApi {
    ...
    public Profile saveProfile( User user, ProfileForm profileForm) throws UnauthorizedException {
        ...
        if (profile == null)
        profile = new Profile(userId, "Haha", mainEmail, teeShirtSize);
        else{
